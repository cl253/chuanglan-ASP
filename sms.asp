...
post_data="{""account"":""zensen"",""password"":""a."",""phone"":""phone"",""msg"":""Server.URLEncode(【253云通讯】您好，您的验证码是999999)"",""report"":""false""}"
response.Write(Post(target,post_data))
dim post
post=Post(target,post_data)
return post
''//请自己解析Post(target,post_data)返回的json格式并实现自己的
